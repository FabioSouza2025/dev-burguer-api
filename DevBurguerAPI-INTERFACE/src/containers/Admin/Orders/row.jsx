...
import { orderStatusOptions } from '../Orders/orderStatus';
import { api } from '../../../services/api';

export function Row({ row, setOrders, orders }) { // Desestruturação correta
  console.log(row)
                ...
                <TableBody>
                  {Array.isArray(row.products) && row.products.map((product) => (
                    <TableRow key={product.id}>
                      <TableCell component="th" scope="row">
                        {product.quantity} {/* Exibindo a quantidade */}
                      </TableCell>
